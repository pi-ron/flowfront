...
<template>
  <RadioGroup v-model="selectedColor">
    <RadioGroupLabel class="block text-sm font-medium text-gray-700">Choose the closest color to your vehicle</RadioGroupLabel>
...
const colors = [
  ...
  { name: 'Brown', bgColor: 'bg-yellow-800', selectedColor: 'ring-yello-800' },
